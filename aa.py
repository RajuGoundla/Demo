...
# Remove null values and duplicate values from the 'BOROUGH' and 'ZIP CODE' columns
original_df.dropna(subset=['BOROUGH', 'ZIP CODE'], inplace=True)
original_df.drop_duplicates(subset=['BOROUGH', 'ZIP CODE'], inplace=True)
...
unique_combinations = original_df[['LATITUDE', 'LONGITUDE', 'BOROUGH', 'ZIP CODE']].drop_duplicates()
